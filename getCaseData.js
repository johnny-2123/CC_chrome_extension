...
console.log(`chargeMatch`, chargeMatch)
const suffix = "Case Type";
...
const resultString = `${caseNumber}\t${caseType}\t${offenseDate}\t${charge}\t${codeSection}\t${disposition}\t${sentenceTime}`;
